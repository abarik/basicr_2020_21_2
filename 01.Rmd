...
```{r echo=FALSE, results='asis', out.width='60%', fig.cap='How to use R – the best way', fig.align='center'}
knitr::include_graphics('img/baser_rstudio.jpg')
```
...
```{r echo=FALSE, results='asis', out.width='60%', fig.cap='How to use R – the minimum way', fig.align='center'}
knitr::include_graphics('img/baser_rstudio_min.jpg')
```
...
```{r echo=FALSE, results='asis', out.width='90%', fig.cap='How to use R – the minimum way', fig.align='center'}
knitr::include_graphics('img/baser_rstudio_all.jpg')
```
...
```{r echo=FALSE, results='asis', out.width='70%', fig.cap='Components of Base R', fig.align='center'}
knitr::include_graphics('img/baser.jpg')
```
...
```{r echo=FALSE, results='asis', out.width='70%', fig.cap='Console in Base R', fig.align='center'}
...
:   Lets's have a look at a small example. Tpye `45 -`(fortyfive minus)
    ...
    continue prompt indicated by a `+` (plus) followed by a space
    ...
    <kbd>Enter</kbd>. We will get the contunie prompt, and typing
    closing parenthesis we get the working directory. It seems to help
    us. Continue prompt seems to be a good thing. But, It is not. It is
    a really confusing feature. We can easely find ourselves in a never
    ending story. We can type `45 -`, <kbd>Enter</kbd>, `11 *`,
    <kbd>Enter</kbd> and so on, we keep getting the countine prompt, and
    we don't really know how to complete it in a right way. So, It is
    very important to leave the continue prompt as soon as possible. The
    ...
    this is defalt prompt. When you see the plus prompt, countinue
...
```{r echo=FALSE, results='asis', out.width='70%', fig.cap='Console in RGui', fig.align='center'}
...
```{r echo=FALSE, results='asis', out.width='70%', fig.cap='Console in RGui', fig.align='center'}
knitr::include_graphics('img/rgui_script.jpg')
```
