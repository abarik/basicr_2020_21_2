...
```{r matfuggvenyek, echo=FALSE, message=FALSE, warning=FALSE}
library(kableExtra)
library(dplyr)
table.kiir <- data.frame(A=c( "abs(x)", 
                              ...
                              "ceiling(x)", 
                              "trunc(x)"),
                         B= c("Takes the absolute value of x",
                              "The signs of `x`",
                              "Returns the square root of x",
                              "Returns the exponential of x",
                              "Takes the logarithm of x with base y; if base is not specified, returns the natural logarithm",
                              "Takes the logarithm of x with base 10 or 2",
                              "Trigonometric functions",
                              "Rounds a numeric input to a specified number of decimal places",
                              "Rounds a numeric input down to the next lower integer",
                              "Rounds a numeric input up to the next higher integer",
                              "Truncates (i.e. cuts off) the decimal places of a numeric input"
                              ),
                         C=c( "abs(-1)",
                              "sign(pi)",
                              "sqrt(9+16)",
...
table.kiir %>% 
  mutate(A=cell_spec(A, "html", monospace = T)) %>% 
  mutate(C=cell_spec(C, "html", monospace = T)) %>% 
...
```{r statfuggvenyek2, echo=FALSE, message=FALSE, warning=FALSE}
table.kiir <- data.frame(A=c( "max(x)",
                         ...
                         B= c("The largest value of `x`",
                              "The smallest value of `x`",
                              "The sum of all the values of `x`",
                              "The product of all the values of `x`",
                              "Mean of `x`",
                              "Median of `x`",
...
table.kiir %>% 
  mutate(A=cell_spec(A, "html", monospace = T)) %>%
  mutate(C=cell_spec(C, "html", monospace = T)) %>%
  mutate(D=cell_spec(D, "html", monospace = T)) %>%   
knitr::kable(escape = F, booktabs = T, 
   col.names = c("Function",
                "Description",
                "Example",
                "Value of Example"),
  caption = 'Base R Statistical Functions',
  format = "pandoc") %>% 
