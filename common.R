...
options(
  htmltools.dir.version = FALSE, formatR.indent = 2, scipen = 0,
  width = 65, digits = 7, warnPartialMatchAttr = FALSE, warnPartialMatchDollar = FALSE
)
...
# 
# 
# pdf.options(encoding = "CP1250")  # a magyar ékezetes ábrák miatt
# 
# 
